...
def create_marketing_image(product_image, punchline_text, button_text, punchline_and_button_color):
    ...
    logo_path = "/Users/furkangulenc/Desktop/addCreativeTask/assets/logo.jpg"
    ...
    # Genel görselin boyutlarını ayarla
    ...
    image.paste(logo, ((width - logo.width) // 2, 10))  # Logo'yu merkezle
    ...
    draw.multiline_text(((width - text_width) / 2, text_y), punchline_text, fill=punchline_and_button_color, font=font, align="center")
    ...
    draw.multiline_text(((width - button_text_width) / 2, button_y + (button_height - button_text_height) / 2), button_text, fill="white", font=font, align="center", stroke_width=60)
